 ...
 */
export function buildVisitReminderHtml({ visitorFirstName, whenLabel, propertyAddress, mapUrl, agent = {} }) {
...
<p style="font-size:11px;color:#aaa;text-align:center;margin-top:20px;line-height:1.5">
    Rappel automatique concernant une visite que vous avez planifiée.<br>
