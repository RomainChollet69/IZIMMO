...
// Libellé + couleur de chaque type de lien. L'ordre définit l'ordre d'affichage des boutons.
const LINK_BUTTONS = [
    { key: 'documents',   label: '📄 Documents du bien',   color: '#2C3E50' },
    { key: 'virtualTour', label: '🎥 Visite virtuelle',     color: '#667eea' },
    { key: 'listing',     label: '🔗 Voir l\'annonce',      color: '#764ba2' }
];
 ...
 * @param {Object} [params.agent] - { name, agency, avatarUrl, showPhoto }
...
export function buildVisitFollowupHtml({ visitorFirstName, propertyLabel, links = {}, agent = {} }) {
    ...
    // Boutons : uniquement les liens fournis, dans l'ordre de LINK_BUTTONS.
