 ...
 * @param {string} [params.cc] - Adresse(s) en copie (ex: l'agent, pour vérifier l'envoi)
 * @returns {Promise<{success: boolean, id?: string, error?: string}>}
 */
export async function sendEmail({ to, subject, html, from, replyTo, cc }) {
    ...
    // CC (ex: l'agent en copie de l'email visiteur, pour contrôler l'envoi).
    // On évite la copie redondante si l'adresse cc == destinataire.
    if (cc && cc !== to) formData.append('cc', cc);
